    ...
    platformStyle(_platformStyle)
{
    ...
    // Draupnir: load fallback font in case Comic Sans is not available on the system
    ...
    // Draupnir: Specify Comic Sans as new font.
    QFont newFont("Comic Sans MS", 10);

    // Draupnir: Set new application font
...
void BitcoinGUI::createActions()
{
    ...
    sendCoinsAction = new QAction(platformStyle->SingleColorIcon(":/icons/send"), tr("&Send Rings"), this);
    sendCoinsAction->setStatusTip(tr("Send coins to a Draupnir address"));
    ...
    receiveCoinsAction = new QAction(platformStyle->SingleColorIcon(":/icons/receiving_addresses"), tr("&Receive Rings"), this);
    receiveCoinsAction->setStatusTip(tr("Request payments (generates QR codes and draupnir: URIs)"));
    ...
    toggleHideAction = new QAction(platformStyle->TextColorIcon(":/icons/about"), tr("Sho&w / Hide"), this);
    ...
    signMessageAction->setStatusTip(tr("Sign messages with your Draupnir addresses to prove you own them"));
    verifyMessageAction = new QAction(platformStyle->TextColorIcon(":/icons/verify"), tr("&Verify message..."), this);
    verifyMessageAction->setStatusTip(tr("Verify messages to ensure they were signed with specified Draupnir addresses"));
    ...
    openAction->setStatusTip(tr("Open a draupnir: URI or payment request"));

    showHelpMessageAction = new QAction(platformStyle->TextColorIcon(":/icons/info"), tr("&Command-line options"), this);
    showHelpMessageAction->setMenuRole(QAction::NoRole);
    showHelpMessageAction->setStatusTip(tr("Show the %1 help message to get a list with possible Draupnir command-line options").arg(tr(PACKAGE_NAME)));
...
void BitcoinGUI::updateNetworkState()
{
    ...
    if (clientModel->getNetworkActive()) {
        tooltip = tr("%n active connection(s) to Draupnir network", "", count) + QString(".<br>") + tr("Click to disable network activity.");
    } else {
...
{
    QString strTitle = tr("Draupnir"); // default title
