...
static int AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc<2 || IsArgSet("-?") || IsArgSet("-h") || IsArgSet("-help"))
    {
        ...
        std::string strUsage = strprintf(_("%s draupnir-tx utility version"), _(PACKAGE_NAME)) + " " + FormatFullVersion() + "\n\n" +
            _("Usage:") + "\n" +
              "  draupnir-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded draupnir transaction") + "\n" +
              "  draupnir-tx [options] -create [commands]   " + _("Create hex-encoded draupnir transaction") + "\n" +
              "\n";
