Draupnir Core version 1.14.3 is now available from:

  <https://github.com/draupnir/draupnir/releases/tag/v1.14.3/>
...
Please report bugs using the issue tracker at github:
  ...
  <https://github.com/draupnir/draupnir/issues>

To receive security and update notifications, please watch reddit or Twitter:

  * https://www.reddit.com/r/draupnir/
  * @Draupnir on Twitter for high priority announcements
  * @draupnir\_devs on Twitter for updates on development work
...
Draupnir Core is extensively tested on Ubuntu Server LTS, Mac OS X and Windows 10.
...
Draupnir Core should also work on most other Unix-like systems but is not
...
Block download timeouts are expressed as a multiple of block interval, and as such Draupnir block download times were relatively aggressive, leading to a high number of timeouts. Increased the timeouts to be more flexible to real world conditions.
...
* Return unspents greater or equal than a specific amount in RINGS: minimumAmount (default = 0).
* Return unspents lower or equal than a specific amount in RINGS: maximumAmount (default=unlimited).
* Return unspents with a total number lower or equal than a specific number: maximumCount (default=0=unlimited).
* Return unspents which total is greater or equal than a specific amount in RINGS: minimumSumAmount (default=unlimited).
...
* Change IPC prefix from `bitcoin:` to `draupnir:`.
