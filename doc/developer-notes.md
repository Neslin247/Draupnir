...
- ThreadSocketHandler : Sends/Receives data from peers on port 23237.
...
- ThreadRPCServer : Remote procedure call handler, listens on port 23236 for connections and services them.

- DraupnirMiner : Generates draupnirs (if wallet is enabled).
...
- When looking at other's pull requests, it may make sense to add the following section to your `.git/config`
  file:
        ...
        [remote "upstream-pull"]
                ...
                url = git@github.com:Neslin247/draupnir.git
